...
type UserServiceClient interface {
	GetUserById(ctx context.Context, in *UserWithID, opts ...grpc.CallOption) (*User, error)
	GetAllUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UsersList, error)
	UpdateUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error)
	DeleteUser(ctx context.Context, in *UserWithID, opts ...grpc.CallOption) (*Empty, error)
...
func (c *userServiceClient) GetUserById(ctx context.Context, in *UserWithID, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (c *userServiceClient) DeleteUser(ctx context.Context, in *UserWithID, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type UserServiceServer interface {
	GetUserById(context.Context, *UserWithID) (*User, error)
	GetAllUsers(context.Context, *Empty) (*UsersList, error)
	UpdateUser(context.Context, *User) (*User, error)
	DeleteUser(context.Context, *UserWithID) (*Empty, error)
...
func (UnimplementedUserServiceServer) GetUserById(context.Context, *UserWithID) (*User, error) {
...
func (UnimplementedUserServiceServer) DeleteUser(context.Context, *UserWithID) (*Empty, error) {
...
func _UserService_GetUserById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserById(ctx, req.(*UserWithID))
	}
